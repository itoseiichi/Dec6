...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
	...
	NSString *bgmFilename = [bundle pathForResource:@"obama" ofType:@"mp3"];
	NSURL *bgmURL = [NSURL fileURLWithPath:bgmFilename isDirectory:NO];
	NSError *error = nil;
	player = [[AVAudioPlayer alloc] initWithContentsOfURL:bgmURL error:&error];
	[player play];
